...
if ($category_Arr != '') {
    ...
    $view_type = $category_Arr[0]->view_type;
}
?>
                                    ...
                                    <div class="col-md-9">
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input  <?= $view_type == 11 ? 'checked=""' : '' ?> type="radio" name="view_type" value="11">Quotation 
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <input <?= $view_type == 12 ? 'checked=""' : '' ?> type="radio" name="view_type"  value="12"> Camp & Reports
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
