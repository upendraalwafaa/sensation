                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row qut_null" style="margin-top: 10px;">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <label id="father_email_id"><?= $child_arr == '' ? '' : $child_arr[0]->father_personal_email == '' ? $child_arr[0]->mother_personal_email : $child_arr[0]->father_personal_email ?></label>
                                            </div>
                                        </div>
...
//                                echo '</pre>';exit;
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    if ($adt->session_type == 'Single') {
                                                        $single_d = '';
                                                    } else if ($adt->session_type == 'Multiple' || $adt->session_type == 'Year') {
                                                        $multiple = '';
                                                    }
                                                    if ($category_id == 4) {
                                                        $single_d = 'none';
                            ...
                            <br><br>
                            <div class="portlet light form-fit bordered total-div subtabline ">
