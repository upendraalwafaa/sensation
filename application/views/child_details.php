            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
                ...
                <div class="portlet light portlet-fit bordered">
                    ...
                    <div class="wrap_alldrop">
                        ...
                        <div class="ui-widget">
                            <!--<input tabindex="1" type="text" name="child_names" class="form-control child_names" placeholder="Search for student..."/>--> 
                            <select tabindex="1" id="child_names" class="form-control selectpicker" data-live-search="true">
                                <?php
