                        ...
                        <form role="form" id="edit_marketing_form" method="POST">
                            ...
                            if($marketing)
                            {
                                foreach($marketing as $value)
                                {
                                    ...
                                    if($value->tel_mobile_business_sec==0){$value->tel_mobile_business_sec='';}
                                    if($value->tel_mobile_business==0){$value->tel_mobile_business='';}
                                    if($value->email_private_sec){$sec_email_pvt =$value->email_private_sec;}
                            ?>
                            <div class="form-body">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            ...
                                            <input type="text" class="datepicker form-control insert" value="<?= date('d-m-Y',$value->entry_date); ?>" id="date_entry" name="date_entry" data-id="entry_date" >                                       
                               ...
                               <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            <label><span class="importent_note">*</span>Email: Private</label>
                                                <input value="<?=$value->email_private;?>" type="text" id="email" class="form-control insert" name="email" data-id="email_private">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        ...
                                        <label>Email 2: Private</label>
                                            <input type="text" class="form-control insert" name="" id="email2" data-id="email_business" value="<?=$sec_email_pvt;?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            ...
                                            <input value="<?=$value->email_business;?>" type="text" id="email_business" class="form-control insert" name="email_business" data-id="">
                                        </div>
                                    </div>
                                </div>
                                <div  class="col-md-6">
                                     <div class="form-group form-md-line-input has-success">
                                        ...
                                        <label>Email 2: Business</label>
                                            <input type="text" class="form-control insert" name="" id="email_business2" data-id="email_business_sec" value="<?=$value->email_business_sec;?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            <label>Country</label>
                                           <input value="<?=$value->country;?>" type="text" id="country" class="form-control insert" name="country" data-id="country">
                                    ...
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            <label>Child’s Date of Birth</label>
                                             <input value="<?php if($value->child_dob){ echo date('Y-m-d',$value->child_dob);}?>" type="text" id="child_dob" class="datepicker  form-control insert" name="child_dob" data-id="child_dob">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            <label>Parent’s DOB</label>
                                             <input value="<?php if($value->parent_dob){echo date('Y-m-d',$value->parent_dob);}?>" type="text" id="parent_dob" class=" datepicker form-control insert" name ="parent_dob" data-id="parent_dob">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="md-radio-inline">
                                        ...
                                        <div class="md-radio">
                                            <input 
                                             <?= $value->religion== '' ? '' : $value->religion == 'Other' ? 'checked="checked"' : '' ?>
                           ...
                           <div  class="col-md-6">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <label>Please Specify the Refferal Name </label>
                                        </br></br>
                                        <input value="<?=$value->internet_other?>" type="text"  id="referral_name" class="form-control insert" name ="referral_name" data-id="about_us_specify">
                                    </div>
                                </div>     
                            </div>
                            ...
                            <div   class="col-md-6"  >
                                 <div class="form-group form-md-line-input has-success" >
                                    <div class="input-icon">
                                        <label>Please Specify Other Media </label>
                                        </br></br>
                                ...
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <label>Speech Language Therapy</label>
                                            ...
                                            <div class="md-radio">
                                                <input 
                                                <?= $value->therapy_specify== '' ? '' : $value->therapy_specify == 'Centre' ? 'checked="checked"' : '' ?>
                                                type="radio" id="speech_centre" name="speech_lang" class="md-radiobtn" value="Centre">
                                            ...
                                            <div class="md-radio has-success">
                                                <input 
                                                 <?= $value->therapy_specify== '' ? '' : $value->therapy_specify == 'Outreach' ? 'checked="checked"' : '' ?>
                                                type="radio" id="speech_outreach" name="speech_lang" class="md-radiobtn" value="Outreach">
                             ...
                             <div  class="col-md-6"  >
                                 <div class="form-group form-md-line-input has-success" >
                                    <div class="input-icon">
                                        <label>Please Specify Other Active client</label>
                                        </br></br>
                            ...
                            <div  class="col-md-6"  >
                                 <div class="form-group form-md-line-input has-success" >
                                    <div class="input-icon">
                                        <label>Please Specify Other Category</label>
                                        </br></br>
