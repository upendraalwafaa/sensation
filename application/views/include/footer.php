...
$datatable_arr = ['view_category', 'accept_policy_procedure', 'view_disipline', 'view_subcategory', 'view_service', 'view_employee', 'view_policy_procedure', 'view_policy_accepted_list', 'reg_view', 'quotation_reports',
    'view_quotation', 'electronic_quotation_details', 'view_child_details', 'therapy_note_lists', 'view_marketing', 'view_outsidestudent', 'list_therapy_notes', 'create_receipt', 'registration_reports', 'create_reports', 'receipt_reports', 'capacity_reports', 'view_camp_reports', 'view_single_session', 'marketing_reports', 'child_details'
];
?>
...
<script src="<?= base_url() ?>js/bootstrap-select.js" defer></script>
<?php if ($current_method == '') { ?>
    ...
    <script src="<?= base_url() ?>assets/global/plugins/counterup/jquery.counterup.min.js"></script>
...
<?php if (in_array($current_method, $datatable_arr)) { ?>
    ...
    <script src="<?= base_url() ?>assets/pages/scripts/table-datatables-rowreorder.min_class.js" type="text/javascript"></script>
<?php } ?>
...
if ($current_method == 'child_details' || $current_method == 'list_therapy_notes' || $current_method == 'accept_policy_procedure' || $current_method == 'view_single_session' || $current_method == 'therapy_note_lists' || $current_method == 'policy_procedure') {
...
if ($current_method == 'add_campreports' || $current_method == 'view_camp_reports') {
    ...
    if ($current_method == 'create_reports' || $current_method == 'receipt_reports' || $current_method == 'report_types' || $current_method == 'registration_reports' || $current_method == 'quotation_reports') {
