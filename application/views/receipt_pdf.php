        ...
        <table  width="100%" style="  margin-top:10px;font-size:13px;">
            <tr>
                <td style="text-align:center">
                    <img src="<?= base_url() . 'files/images/logo-big-black_white.png'; ?>" style="margin-top:10px;"> 
                        <br />
                                        ...
                                        T: +9714 – 2776769<br>
                                            <a href="mailto:info@sensationstation.ae" style="color:#000; text-decoration:none;" >info@sensationstation.ae</a> <br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" style=" border-bottom:1px solid #000;border-right:1px solid #000;"><?= $payment_his == '' ? date('d/m/Y', strtotime($qdel->date_time)) : date('d/m/Y', strtotime($payment_his[0]->timestamp)) ?> </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" style=" border-bottom:1px solid #000;border-right:1px solid #000;"><a href="mailto:naomi.diria@jumeirah.com" style="color:#000; text-decoration:none;" ><?php
                                                            if ($electronic_link_arr == '') {
                                                                $parent_email = $chld->father_personal_email;
                                                                if ($parent_email == '') {
                                                                    $parent_email = $chld->mother_personal_email;
                                                                }
                                                                echo $parent_email;
                                                            } else {
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" bgcolor="#f2f2f2" style="border-left:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;">Generated By : </td>
                                                    <td align="left" valign="top" style=" border-bottom:1px solid #000;border-right:1px solid #000;"><?= $payment_his == '' ? $qdel->genrated_by : $payment_his[0]->genrated_by ?></td>
                                                </tr>
                                                <?php if ($payment_his != '') { ?>
                                                    <tr>
                                                        <td align="left" valign="top" bgcolor="#f2f2f2" style="border-left:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;">Paid By : </td>
                                                        <td align="left" valign="top" style=" border-bottom:1px solid #000;border-right:1px solid #000;"><?= get_paid_name_by_paid_id($payment_his[0]->paid_by) ?></td>
                                                    </tr>
                                                <?php } ?>
                                                </table>
                                                ...
                                                <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" dir="ltr" style="font-size:11px;margin-top:15px;padding:3px">
                                                    ...
                                                    for ($m = 0; $m < count($all_details); $m++) {
                                                        ...
                                                        if (in_array($category_id, $report_arr)) {
                                                            ?> <tr>
                                                                <td   align="left" valign="top" style="border-left:1px solid #000;border-bottom:1px solid #000"><?= $q_d_d->category_name . ' (' . $q_d_d->sub_category_name . ')' ?></td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="middle" style="border:1px solid #000;" >
                                                            ...
                                                            for ($sh = 0; $sh < count($sheduling); $sh++) {
                                                                ...
                                                                $d = $sheduling[$sh];
                                                                if (in_array($category_id, $report_arr)) {
                                                                    echo date('d M', strtotime($d->s_dt)) . ' - ' . date('d M', strtotime($d->e_dt)) . ',&nbsp;&nbsp;';
                                                                } else {
